...
# import spacy 
import spacy
# specifying the more advanced model 
nlp = spacy.load('en_core_web_md')

# import the 2 longer texts and compare them
...
# compare the similarity of the complaints to ascertain if spaCy's similarity model is able to distinguish between these long pieces of text
...
# From my observations, I can see that the 'en_core_web_md' model boasts a more accurate entity similarity reading, 
# it recognises the vocabulary concerning food, as well as discerning words in the complains. 
# I am surprised with recipies similarity is more similar to complaints, with every sentence's similarity boasting over 0.5 similarity.
# This also shows that NLP is not perfect, and still requires human correction for better accuracy. 
